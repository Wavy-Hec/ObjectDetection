...
_EXPORTS = {
    ...
    "Detection": "detector",
    "needs_yolo_world": "detector",
    "COCO_CLASSES": "detector",
    "Tracker": "tracker",
    "Track": "tracker",
    "KalmanBoxTracker": "tracker",
    "create_video_source": "video_source",
    "VideoSource": "video_source",
    "VideoSourceError": "video_source",
    "WebcamSource": "video_source",
    "VideoFileSource": "video_source",
    "StreamSource": "video_source",
    "LatestFrameGrabber": "video_source",
    "draw_tracks": "visualization",
    "draw_segmentation_masks": "visualization",
    "get_color_for_track": "visualization",
    "Pipeline": "pipeline",
    "ProcessResult": "pipeline",
    "FrameStats": "pipeline",
    "FPSTracker": "pipeline",
    "AppConfig": "config",
    "load_config": "config",
    ...
    "LineCrossingCounter": "analytics",
    "Zone": "analytics",
    "ZoneManager": "analytics",
    "HeatmapAccumulator": "analytics",
    "EventClipRecorder": "analytics",
    "CSVExporter": "analytics",
    "SQLiteExporter": "analytics",
    "Event": "analytics",
    "FrameContext": "analytics",
}
